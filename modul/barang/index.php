            ...
            <div class="modal-content">
                ...
                <form action="modul/barang/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="deskrips">Deskripsi</label>
...
<table id="myTable">
    ...
    <tbody>
        <?php
        $sql_barang = "SELECT * FROM barang a INNER JOIN pemasok b ON a.id_pemasok=b.id_pemasok INNER JOIN kategori c
        ON a.id_kategori = c.id_kategori  ORDER BY a.id_barang ASC";
